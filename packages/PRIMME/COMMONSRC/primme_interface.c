...
//#include <unistd.h>   // gethostname		// [RMS]
#include <stdio.h>    
#include "primme.h"
...
void *primme_valloc(size_t byteSize, const char *target) {
   ...
   void *ptr;
   static char * machineName = "LocalHost";		// [RMS]

   // [RMS] no longer memory aligned....is memory  alignment really necessary??
...
//   char machineName[256];
   static const char * machineName = "LocalHost";
