...
#ifdef STANDARD_CLAPACK

// not actually used...
#define ZDOTCSUB  f2c_zdotcsub
#define ZCOPY  f2c_zcopy
#define ZSWAP  f2c_zswap
#define ZGEMM  f2c_zgemm
#define ZHEMM  f2c_zhemm
#define ZAXPY  f2c_zaxpy
#define ZGEMV  f2c_zgemv
#define ZSCAL  f2c_zscal
...
#define DSWAP  f2c_dswap
#define DGEMM  f2c_dgemm
#define DSYMM  f2c_dsymm
...
// blas
#define DCOPY  ATL_dcopy
#define DSWAP  ATL_dswap
#define DGEMM  ATL_dgemm
#define DSYMM  ATL_dsymm
#define DAXPY  ATL_daxpy
#define DGEMV  ATL_dgemv
#define DDOT   ATL_ddot
#define DSCAL  ATL_dscal
// lapack
#define DLARNV dlarnv_
#define DSYEV  dsyev_
#define DSYTRF dsytrf_
...
#error you need to define a LAPACK implementation
...
/* [RMS] config code from PRIMME distrib
